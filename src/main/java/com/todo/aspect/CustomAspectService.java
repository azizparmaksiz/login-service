...
public class CustomAspectService {
	...
	@AfterThrowing(
			pointcut = "execution(* *(..)) &&(within(com.todo.service.*) || within(com.todo.repository.*) || within(com.todo.config.*))",
			throwing = "e")
	 ...
	 */
	@Pointcut("execution(* *(..)) &&(within(com.todo.controller.*) ||  within(com.todo.service.*) || within(com.reposityory.*))")
