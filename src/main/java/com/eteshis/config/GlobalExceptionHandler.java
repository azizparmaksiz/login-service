...
import com.eteshis.dto.ValidationErrorDTO;
import com.eteshis.exception.*;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ResponseBody
    protected ResponseEntity<ExceptionMessage> payExceptionFound(PayException ex, WebRequest request) {
        log.error(ex.getMessage());
